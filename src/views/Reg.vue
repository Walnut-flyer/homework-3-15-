              ...
              <form method="post">
                <div class="layui-form-item">
                  <validation-provider name="username"
                    ...
                    <div class="error imooc-br layui-form-mid">{{errors[0]}}</div>
                  </validation-provider>
                </div>
                <div class="layui-form-item">
                  <label for="L_username"
                         class="layui-form-label">昵称</label>
                  <validation-provider name="nickname"
                ...
                <validation-observer>
                  ...
                  <div class="layui-form-item">
                    ...
                    <validation-provider name="repassword"
                                         rules="required|min:6|max:12|confirmed:confirmation"
                                         v-slot="{errors}">
                      <div class="layui-input-inline">
                        <input type="password"
                               id="L_repassword"
